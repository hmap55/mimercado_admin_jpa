...
<body>
		...
		<div class="header-admin">
			...
			<div class="header-usuario">
				<h3 class="header-carrito-usuario">
					...
					Mi nombre:<span id="nombre"> ${sesionLog} </span><span><i
	...
	<form
		action="${pageContext.request.contextPath}/Servletproductos?accion=modificar&idProducto=${producto.id}"
		method="post" class="was-validated">

		<jsp:include page="/WEB-INF/paginas/productos/botonesEditar.jsp" />
		<section id="details">
			<div class="container">
							...
							<div class="card-body">
								<div class="form-group">
									<label for="nombre">Nombre</label> <input type="text"
										class="form-control" name="nombre" required value="${producto.nombre}">
								</div>

								<div class="form-group">
									<label for="precio">Precio</label> <input type="number"
										class="form-control" name="precio" required  value="${producto.precio}">
								</div>

								<div class="form-group">
									<label for="inventario">Inventario</label> <input type="number"
										class="form-control" name="inventario" required  value="${producto.inventario}">
								</div>

								<div class="form-group">
									<label for="url">Url imagen</label> <input type="text"
										class="form-control" name="url" required  value="${producto.url}">
								</div>

								<div class="form-group">
									<label for="seccion">Seccion</label> <input type="text"
										class="form-control" name="seccion" required  value="${producto.seccion}">
								</div>

								<div class="form-group">
									<label for="promocion">Promocion</label> <input type="text"
										class="form-control" name="promocion"  value="${producto.promocion}">
								</div>
							</div>
